...
function createOrg3 {
  ...
  set -x
  bitnami/hyperledger-fabric-ca:latest-client enroll -u https://admin:adminpw@localhost:11054 --caname ca-org3 --tls.certfiles "${PWD}/bitnami/hyperledger-fabric-ca:latest/org3/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
	bitnami/hyperledger-fabric-ca:latest-client register --caname ca-org3 --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles "${PWD}/bitnami/hyperledger-fabric-ca:latest/org3/tls-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Registering user"
  set -x
  bitnami/hyperledger-fabric-ca:latest-client register --caname ca-org3 --id.name user1 --id.secret user1pw --id.type client --tls.certfiles "${PWD}/bitnami/hyperledger-fabric-ca:latest/org3/tls-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Registering the org admin"
  set -x
  bitnami/hyperledger-fabric-ca:latest-client register --caname ca-org3 --id.name org3admin --id.secret org3adminpw --id.type admin --tls.certfiles "${PWD}/bitnami/hyperledger-fabric-ca:latest/org3/tls-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Generating the peer0 msp"
  set -x
	bitnami/hyperledger-fabric-ca:latest-client enroll -u https://peer0:peer0pw@localhost:11054 --caname ca-org3 -M "${PWD}/../organizations/peerOrganizations/org3.example.com/peers/peer0.org3.example.com/msp" --csr.hosts peer0.org3.example.com --tls.certfiles "${PWD}/bitnami/hyperledger-fabric-ca:latest/org3/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  bitnami/hyperledger-fabric-ca:latest-client enroll -u https://peer0:peer0pw@localhost:11054 --caname ca-org3 -M "${PWD}/../organizations/peerOrganizations/org3.example.com/peers/peer0.org3.example.com/tls" --enrollment.profile tls --csr.hosts peer0.org3.example.com --csr.hosts localhost --tls.certfiles "${PWD}/bitnami/hyperledger-fabric-ca:latest/org3/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
	bitnami/hyperledger-fabric-ca:latest-client enroll -u https://user1:user1pw@localhost:11054 --caname ca-org3 -M "${PWD}/../organizations/peerOrganizations/org3.example.com/users/User1@org3.example.com/msp" --tls.certfiles "${PWD}/bitnami/hyperledger-fabric-ca:latest/org3/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
	bitnami/hyperledger-fabric-ca:latest-client enroll -u https://org3admin:org3adminpw@localhost:11054 --caname ca-org3 -M "${PWD}/../organizations/peerOrganizations/org3.example.com/users/Admin@org3.example.com/msp" --tls.certfiles "${PWD}/bitnami/hyperledger-fabric-ca:latest/org3/tls-cert.pem"
  { set +x; } 2>/dev/null
